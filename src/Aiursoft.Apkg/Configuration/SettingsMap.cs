...
public class SettingsMap
{
    ...
    public static readonly List<GlobalSettingDefinition> Definitions = new()
    {
        ...
        new GlobalSettingDefinition
        {
            ...
            Description = Localizer["Public base URL used in generated APT sources and AppStream screenshot links, for example https://packages.example.com. Set it when /artifacts is served by a separate domain or CDN. It may be left empty when this web app serves the repository itself, unless AppStream screenshots are published; background catalog generation cannot infer their public URL."],
            Type = SettingType.Text,
            DefaultValue = ""
        }
    };
